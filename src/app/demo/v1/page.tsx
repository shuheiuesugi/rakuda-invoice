              ...
              {invoices.map((inv, i) => {
                ...
                return (
                  <tr key={i} style={{ borderBottom: "1px solid rgba(255, 255, 255, 0.03)" }}>
                    <td style={{ padding: "14px 24px", fontSize: 13, color: "#e2e8f0", fontWeight: 500 }}>{inv.id}</td>
                    <td style={{ padding: "14px 24px", fontSize: 13, color: "#c8d1dc" }}>{inv.client}</td>
                    <td style={{ padding: "14px 24px", fontSize: 13, color: "#e2e8f0", fontWeight: 600 }}>{formatCurrency(inv.amount)}</td>
                    <td style={{ padding: "14px 24px", fontSize: 13, color: "#7a8494" }}>{inv.issued}</td>
                    <td style={{ padding: "14px 24px", fontSize: 13, color: "#7a8494" }}>{inv.due}</td>
